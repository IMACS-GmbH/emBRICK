 ...
 *
*/
#define					BB_SYNCHGAP			90


/*
 * Value:	            Time for 1 byte transfer in us. Normally this is 8 divided by the Bus frequency, in case of a delay between the bytes this delay must be added. 
 ...
 *
*/
#define					SET_BB_TIMING(node,a)             bb_setTiming(75000)
