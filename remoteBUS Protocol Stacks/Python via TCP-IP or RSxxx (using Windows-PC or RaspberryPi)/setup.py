...
setup(
  ...
  download_url = 'https://github.com/IMACS-GmbH/Python/archive/refs/tags/v_01.tar.gz',    # I explain this later on
  keywords = ['IMACS', 'EMBRICK', 'PYTHON'],   # Keywords that define your package best
